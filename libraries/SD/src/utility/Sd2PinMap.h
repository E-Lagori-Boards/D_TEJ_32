...
#else
  unsigned char const SDA_PIN = 18;
  unsigned char const SCL_PIN = 19;

  // SPI port
  unsigned char const SS_PIN = 10;
  unsigned char const MOSI_PIN = 11;
  unsigned char const MISO_PIN = 12;
  unsigned char const SCK_PIN = 13;
