 ...
 * 
 * Note: Check and upload the "Post_NodeMCUtoFirebase.ino" file in NodeMCU module, before uploading this code in ARIES v2
 * 
 ...
 * D8 (TXD)      -   RX1
 * 
 * ***Note: Check the PostDemo_NodeMCUtoFirebase.ino file  also before uploading this code
 *         
 ...
 * Upload the below code to ARIES v2 by connecting USB to ARIES v2 and see the output in your Firebase cloud
 *      
*/
